/**
 * Seed Routes and Taluks into the database.
 *
 * Usage:
 *   node datainsert/routes/seedRoutes.js
 *
 * Reads the adjacent seedRoutes.sql file and executes it against the
...
const SQL_FILE = path.resolve(__dirname, "seedRoutes.sql");
